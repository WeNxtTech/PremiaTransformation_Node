...
class DropdownService {
  async getDropdownData(queryParams) {
    ...
    const specialQueries = {
      ...
      PCON_CODE :"SELECT ROWID,PACO_CODE,PACO_DESC,NULL,NULL FROM  PGIM_PROD_APPL_COND WHERE ROWID IN ( SELECT MAX(ROWID) FROM PGIM_PROD_APPL_COND WHERE PACO_PROD_CODE= :prodCode AND PACO_LVL = 'SEC' AND PACO_SEC_CODE = :secCode GROUP BY PACO_CODE)",
