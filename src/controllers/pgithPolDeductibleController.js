const pgithPolDeductibleService = require('../services/pgithPolDeductibleService');
...
exports.getAll = async (req, res, next) => {
  try {
    ...
    const result = await pgithPolDeductibleService.getAll(filters, queryOptions);
...
exports.create = async (req, res, next) => {
  try {
    const result = await pgithPolDeductibleService.create(req.body);
...
exports.update = async (req, res, next) => {
  try {
    const result = await pgithPolDeductibleService.update(req.params.id, req.body);
...
exports.deleteItem = async (req, res, next) => {
  try {
    const result = await pgithPolDeductibleService.deleteItem(req.params.id);
...
exports.getByPolSysId = async (req, res, next) => {
  try {
    ...
    const result = await pgithPolDeductibleService.getByPolSysId(Number(polSysId));
