const pgithPolRiskSmiService = require('../services/pgithPolRiskSmiService');
...
exports.getAll = async (req, res, next) => {
  try {
    ...
    const result = await pgithPolRiskSmiService.getAll(filters, queryOptions);
...
exports.create = async (req, res, next) => {
  try {
    const result = await pgithPolRiskSmiService.create(req.body);
...
exports.update = async (req, res, next) => {
  try {
    const result = await pgithPolRiskSmiService.update(req.params.id, req.body);
...
exports.deleteItem = async (req, res, next) => {
  try {
    const result = await pgithPolRiskSmiService.deleteItem(req.params.id);
...
exports.getByPolSysId = async (req, res, next) => {
  try {
    ...
    const result = await pgithPolRiskSmiService.getByPolSysId(Number(polSysId));
