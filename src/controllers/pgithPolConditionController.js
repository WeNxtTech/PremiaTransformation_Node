const pgithPolConditionService = require('../services/pgithPolConditionService');
...
exports.getAll = async (req, res, next) => {
  try {
    ...
    const result = await pgithPolConditionService.getAll(filters, queryOptions);
...
exports.create = async (req, res, next) => {
  try {
    const result = await pgithPolConditionService.create(req.body);
...
exports.update = async (req, res, next) => {
  try {
    const result = await pgithPolConditionService.update(req.params.id, req.body);
...
exports.deleteItem = async (req, res, next) => {
  try {
    const result = await pgithPolConditionService.deleteItem(req.params.id);
