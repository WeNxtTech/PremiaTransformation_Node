const pgithPolPrevInsDtlService = require('../services/pgithPolPrevInsDtlService');
...
exports.getAll = async (req, res, next) => {
  try {
    ...
    const result = await pgithPolPrevInsDtlService.getAll(filters, queryOptions);
...
exports.create = async (req, res, next) => {
  try {
    const result = await pgithPolPrevInsDtlService.create(req.body);
...
exports.update = async (req, res, next) => {
  try {
    const result = await pgithPolPrevInsDtlService.update(req.params.id, req.body);
...
exports.deleteItem = async (req, res, next) => {
  try {
    const result = await pgithPolPrevInsDtlService.deleteItem(req.params.id);
...
exports.getByPolSysId = async (req, res, next) => {
  try {
    ...
    const result = await pgithPolPrevInsDtlService.getByPolSysId(Number(polSysId));
